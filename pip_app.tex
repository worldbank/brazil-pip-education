...
\begin{document}
	...
	\begin{table}[!ht]
		...
		\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{lcccccc} \hline \hline
				\input{DataWork/Output/Tables/tabC1-test_studentlevel_ctrl.tex}
	...
	\begin{table}[!ht]
		...
		\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{lcccccc} \hline \hline
				\input{DataWork/Output/Tables/tabC2-test_studentlevel_DIM.tex}
	...
	\begin{table}[ht!]
		...
		\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{lcccccc} \hline \hline
				\input{DataWork/Output/Tables/tabC3-test_studentlevel_IWE.tex}
	...
	\begin{table}[ht!]
		...
		\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{lcccccc} \hline \hline
				\input{DataWork/Output/Tables/tabC4-test_studentlevel_RWE.tex}
	...
	\begin{table}[ht!]
		...
		\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{lcccccc} \hline \hline
				\input{DataWork/Output/Tables/tabC5-test_schoollevel.tex}
	...
	\begin{table}[ht!]
		...
		\centering
		\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{lccccc} \hline \hline \input{DataWork/Output/Tables/tabC6-test_rescaled_studentlevel.tex} \multicolumn{6}{@{}p{0.87\textwidth}}{\footnotesize \textit{Notes}: \sym{*}Significant at 10\%. \sym{**}Significant at 5\%. \sym{***}Significant at 1\%. Unit of observation: student. All regressions are OLS with strata (i.e., region and grade) fixed effects. Standard errors clustered at the school level.}
			\end{tabular}
		\end{adjustbox}
	\end{table}
	...
	\begin{table}[ht!]
		...
		\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{lcccccccc} \hline \hline
				\input{DataWork/Output/Tables/tabC7-promotion_other_grades.tex}
	...
	\begin{table}[ht!]
		...
		\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{lccccc} \hline \hline
				\input{DataWork/Output/Tables/tabC8-socio_studentlevel_ctrl.tex}
	...
	\begin{table}[ht!]
		...
		\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{lcccccc} \hline \hline
				\input{DataWork/Output/Tables/tabC9-socio_studentlevel_DIM.tex}
	...
	\begin{table}[ht!]
		...
		\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{lcccccc} \hline \hline
				\input{DataWork/Output/Tables/tabC10-socio_studentlevel_IWE.tex}
	...
	\begin{table}[ht!]
		...
		\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{lcccccc} \hline \hline
				\input{DataWork/Output/Tables/tabC11-socio_studentlevel_RWE.tex}
	...
	\begin{table}[ht!]
		...
		\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{lcccccc} \hline \hline
				\input{DataWork/Output/Tables/tabC12-socio_schoollevel.tex}
				\multicolumn{6}{@{}p{1.175\textwidth}}{\footnotesize \textit{Notes}: \sym{*}Significant at 10\%. \sym{**}Significant at 5\%. \sym{***}Significant at 1\%. Unit of observation: school. All regressions are OLS with strata (i.e., region and grade) fixed effects and analytic weights for number of students enrolled in the grade of interest. Robust standard errors in parentheses. The coefficient are expressed in terms of standard deviations from the control group, while mean and standard deviation of the dependent variable refer to the raw values in the control group.}
			\end{tabular}
		\end{adjustbox}
	\end{table}
