	...
	if `analysis'   {
		...
		* -------
			...
			* Dropout and retention in RN
			do "${master_do_anl}/figA2-grade_comparison.do"

			* IDEB
			do "${master_do_anl}/figA1-IDEB_byState.do"

			* PIP resource allocation
			do "${master_do_anl}/figA3-grant.do"

			* Retention and student attainment as outcome of 6th grade
			do "${master_do_anl}/fig1-retention_grade6.do"

			* Implementation by grade
			do "${master_do_anl}/fig2-implementation_byGrade.do"
	...
	if `supplement' {
		...
		* -------
			...
			* IDEB by participation
			do "${master_do_anl}/figA5-predict_participation.do"

			* Quantile regression on average test score
			do "${master_do_anl}/figA6-qreg_media_grade6.do"

			* Distribution and impact by gender
			do "${master_do_anl}/figA7a-kdensity_grade6_byGender.do"
			do "${master_do_anl}/figA7b-qreg_media_grade6_byGender.do"

            * ?
			do "${master_do_anl}/figA8-scatter_test_socio.do"

			* Effect in terms of Prova Brasil
			do "${master_do_anl}/figA9-itt_ProvaBrasil.do"
			do "${master_do_anl}/figA10-itt_IDEB.do"
