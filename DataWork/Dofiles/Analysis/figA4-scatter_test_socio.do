...
********************************************************************************
	...
	** CREATES:	   		Figure A4: Scatter Plot of Cognitive and Socio-Emotional Skills
						"${master_fig}/figA4-scatter_test_socio.png"
	...
	** NOTE:			This applies the same coding tricks to estimate and
						...
						"figA3a-kdensity_grade6_byGender.do"
...
* --------------------------------------------------------------------------- */
	...
	* Export graph in PNG format
	gr export  "${master_fig}/figA4a-scatter_test_socio.png", replace
	...
	* Export graph in PNG format
	gr export  "${master_fig}/figA4b-scatter_test_socio_grade6.png", replace
