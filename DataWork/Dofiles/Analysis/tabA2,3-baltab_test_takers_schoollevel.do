...
********************************************************************************
	...
	** CREATES:			Table A2: Balance Table on Subsample of Schools with Socio-Emotional Test Takers
						"${master_tab}/tabA2-baltab_socio_schoollevel.tex"
						
						Table A3: Balance Table on Subsample of Schools with Proficiency Test Takers
						"${master_tab}/tabA3-baltab_proficiencia_media_schoollevel.tex"
...
* ---------------------------------------------------------------------------- *
	...
	* ---------------------------------------------------------------------------- *
		...
		* Display locals
		...
		if "`testVar'" == "socio" 			   local tabNum "A2"
		if "`testVar'" == "proficiencia_media" local tabNum "A3"
