...
********************************************************************************
	...
	** CREATES:	   		Table A8: Impact on Probability of School Obtaining the Clearance Certificate
						"${master_tab}/tabA8-clerance_certificate.tex"
...
* ---------------------------------------------------------------------------- */
	...
	* Remove spaces
	...
	filefilter "${master_tab}/clerance_certificate_aux.tex"		/// 
			   "${master_tab}/tabA8-clearance_certificate.tex"	///
	...
	* Add link to the file (filefilter does not provide it automatically"
	di as text `"Open final file in LaTeX here: {browse "${master_tab}/tabA-clearance_certificate.tex":${master_tab}/tabA-clearance_certificate.tex}"'
