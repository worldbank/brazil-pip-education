...
********************************************************************************
	...
	** CREATES:	   		Learning Gains in 6th Grade Rescaled to IDEB - Comparison with Other Brazilian States
						"${master_fig}/figA5-itt_IDEB.png"
...
* ---------------------------------------------------------------------------- *
	...
	* Generate variable for position
	...
	gr export "${master_fig}/figA5-itt_IDEB.png", width(5000) as(png) replace
