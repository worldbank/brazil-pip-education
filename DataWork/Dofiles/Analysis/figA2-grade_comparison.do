...
********************************************************************************
	...
	** CREATES:	   		Figure A2: Grade Repetition and School Dropout Rates by Grade in Rio Grande do Norte
						
						(a) Grade Repetition Rate
						"${master_fig}/figA2a-grade_comparison_retention.png"
						
						(b) School Dropout Rate
						"${master_fig}/figA2b-grade_comparison_dropout.png"
...
* ---------------------------------------------------------------------------- */
	...
	* Keep RN - public
	...
	gr  export "${master_fig}/figA2a-grade_comparison_retention.png", replace as(png) width(5000)
	...
	gr  export  "${master_fig}/figA2b-grade_comparison_dropout.png", replace as(png) width(5000)
