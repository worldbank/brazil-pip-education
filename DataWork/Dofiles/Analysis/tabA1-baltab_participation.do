...
********************************************************************************
	...
	** CREATES:			Table A1: Balance in Socio-Emotional and Proficiency Test Participation
						"${master_tab}/tabA1-baltab_participation.tex"
...
* --------------------------------------------------------------------------- */
	...
	* Collapse data by school
	...
	rename  pct_missing_* * 
	sum		socio proficiencia_media
	
	lab var all_missing_socio 	   		   "\addlinespace[0.5em] \textit{Participating schools}     \\[1em] \hspace{1em} All schools"
	lab var all_missing_proficiencia_media "\addlinespace[0.5em] \textit{Participating schools}     \\[1em] \hspace{1em} All schools"
	
	lab var socio 	   		   			   "\addlinespace[0.5em] \textit{Percentage of test takers}	\\[1em] \hspace{1em} All schools"
	lab var proficiencia_media 			   "\addlinespace[0.5em] \textit{Percentage of test takers}	\\[1em] \hspace{1em} All schools"
	...
	* Make table
	file  open finalFile using "${master_tab}/tabA1-baltab_participation.tex"	///
		, text write replace
