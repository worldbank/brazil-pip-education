...
********************************************************************************
	...
	** CREATES:	   		Table C13: Impact on Socio-Emotional Skills - School Level Regressions
						"${master_tab}/tabC13-socio_schoollevel.tex"
...
* ---------------------------------------------------------------------------- */
	...
	* Add link to the file (filefilter does not provide it automatically)
	di as text `"Open final file in LaTeX here: {browse "${master_tab}/tabC13-socio_schoollevel.tex":${master_tab}/tabC13-socio_schoollevel.tex}"'
