...
********************************************************************************
	...
	** CREATES:	   		Table A5: Impact on Student Progression Rate -- Heterogeneity by Passing Rate at Baseline
						"${master_tab}/tabA5-promotion_het.tex"
...
* ---------------------------------------------------------------------------- *	
	...
	* Add link to the file (filefilter does not provide it automatically"
	di as text `"Open final file in LaTeX here: {browse "${master_tab}/tabA5-promotion_het.tex":"${master_tab}/tabA5-promotion_het.tex"}"'
