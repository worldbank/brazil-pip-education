...
********************************************************************************
	...
	** CREATES:	   		Table A7: Drivers of Implementation
						"${master_tab}/tabA7-predict_implementation.tex"
...
* ---------------------------------------------------------------------------- *
	...
	* Export table directly to LaTeX
	#d	;
		esttab 	school70 rate70 clearance70
				...
				coeflabel(school_N_students 	   	   "\addlinespace[0.75em] Number of enrolled students in PIP grades"
						  ...
						  promotion_rate_2015 	   	   "Promotion rate in 2015"
	...
	di as text `"Open final file in LaTeX here: {browse "${master_tab}/tab8-predict_implementation.tex":"${master_tab}/tab8-predict_implementation.tex"}"'
