...
********************************************************************************
	...
	** CREATES:	   		Table A4: Impact on Student Progression Rate -- Heterogeneity by Gender
						"${master_tab}/tabA4-promotion_het_gender.tex"
...
* ---------------------------------------------------------------------------- *
	...
	* Add link to the file (filefilter does not provide it automatically"
	di as text `"Open final file in LaTeX here: {browse "${master_tab}/tabA4-promotion_het_gender.tex":"${master_tab}/tabA3-promotion_het_gender.tex"}"'
