...
********************************************************************************
	...
	** CREATES:	   		Figure A4: Learning Gains in 6th Grade Rescaled to Prova Brasil - Projection over Time
						(a) Math
						"${master_fig}/itt_ProvaBrasil_MT.png"
						(a) Portuguese
						"${master_fig}/itt_ProvaBrasil_LT.png"
...
* ---------------------------------------------------------------------------- *
	...
	foreach subject in MT LT {
		...
		gr 	  export 	  "${master_fig}/figA4`figLetter'-itt_ProvaBrasil_`subject'.png", ///
