...
\begin{document}
	...
	\begin{table}[ht!]
		...
		\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{lcccccccc} \hline \hline
				\input{DataWork/Output/Tables/tabA2-baltab_socio_schoollevel.tex}
	...
	\begin{table}[ht!]
		...
		\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{lcccc} \hline \hline
				\input{DataWork/Output/Tables/tabA4-promotion_het_gender.tex}
	...
	\begin{table}[ht!]
		...
		\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{lcccccccc} \hline \hline
				\input{DataWork/Output/Tables/tabA5-promotion_het.tex}
	...
	\begin{table}[ht!]
		...
		\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{lccc} \hline \hline
				\input{DataWork/Output/Tables/tabA7-predict_implementation.tex}
